...
/**
 * The profile controller for the fbgraph package
 *
 * @version $Id:$
 * @license http://opensource.org/licenses/gpl-license.php GNU Public License, version 2
 */
class Tx_Fbgraph_Controller_ProfileController extends Tx_Extbase_MVC_Controller_ActionController {

	/**
	 * List action for this controller. Displays a facebook profile.
	 *
	 * @return string
	 */
